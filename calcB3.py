...
def style_result_df(df: pd.DataFrame) -> Any:
    ...
    if cols_emphasis:
        sty = sty.set_properties(
            ...
            **{"border-left":"2px solid #000","border-right":"2px solid #000","background-color":"#f6f7f9","font-weight":"700"}
        )
        ...
        for c in cols_emphasis:
            ...
            table_styles.append({
                ...
                "props": [("border","2px solid #000"),("background-color","#f6f7f9"),("font-weight","700")]
            })
